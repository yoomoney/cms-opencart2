...
$_['pokupki_error_token'] = 'Токен не заполнен!';
$_['pokupki_error_url_api'] = 'URL api не заполнен';
$_['pokupki_error_company_number'] = 'Номер кампании не заполнен';
$_['pokupki_error_id'] ='ID приложения не заполнен';
$_['pokupki_error_password'] = 'Пароль приложения не заполнен';
$_['pokupki_error_token_receive'] = 'Токен yandex не получен!';
$_['pokupki_error_status_not_unique'] ='Статусы для передачи в Яндекс.Маркет должны быть уникальными';
$_['pokupki_carrier_post'] = 'Доставка почтой';
$_['pokupki_carrier_pickup'] = 'Самовывоз';
$_['pokupki_carrier_delivery'] = 'Доставка курьером';
