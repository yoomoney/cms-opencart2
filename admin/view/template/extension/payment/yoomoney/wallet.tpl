    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
                <label>
                    <input type="checkbox" id="wallet-enabled" name="yoomoney_wallet_enabled" value="on"<?php echo $wallet->isEnabled() ? ' checked' : ''; ?> class="enable-button" />
        ...
        <div class="form-group required">
            ...
            <div class="col-sm-10">
                <input type="text" name="yoomoney_wallet_account_id" value="<?php echo $wallet->getAccountId(); ?>" placeholder="<?php echo $language->get('wallet_account_id_label'); ?>" id="wallet-account-id" class="form-control" />
        ...
        <div class="form-group required">
            ...
            <div class="col-sm-10">
                <input type="text" name="yoomoney_wallet_password" value="<?php echo $wallet->getPassword(); ?>" placeholder="<?php echo $language->get('wallet_password_label'); ?>" id="wallet-password" class="form-control" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="yoomoney_wallet_display_name" value="<?php echo $wallet->getDisplayName(); ?>" placeholder="<?php echo $language->get('wallet_display_name_label'); ?>" id="wallet-display-name" class="form-control" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <label>
                    <input type="checkbox" name="yoomoney_wallet_create_order_before_redirect" id="yoomoney_wallet_create_order_before_redirect"
                           value="on" <?php echo ($wallet->getCreateOrderBeforeRedirect() ? 'checked' : ''); ?> />
                    <?php echo $language->get('wallet_create_order_label'); ?>
                </label><br />
                <label>
                    <input type="checkbox" name="yoomoney_wallet_clear_cart_before_redirect" id="yoomoney_wallet_clear_cart_before_redirect"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select id="wallet-success-order-status" name="yoomoney_wallet_success_order_status" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="wallet-min-payment-amount" name="yoomoney_wallet_minimum_payment_amount" value="<?php echo $wallet->getMinPaymentAmount(); ?>" class="form-control" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select id="kassa-geo-zone" name="yoomoney_wallet_geo_zone" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" id="wallet-sort-order" name="yoomoney_wallet_sort_order" value="<?php echo $yoomoney_wallet_sort_order; ?>" class="form-control" />
